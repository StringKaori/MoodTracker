...
const data = [
  ...
  { id: 2, date: new Date(2024, 8, 18, 16, 0, 0), note: undefined },
  { id: 3, date: new Date(2024, 8, 18, 17, 0, 0), note: "Sentindo ansiedade por causa do prazo." },
  { id: 4, date: new Date(2024, 8, 18, 18, 0, 0), note: undefined },
  ...
  { id: 7, date: new Date(2024, 8, 18, 21, 0, 0), note: undefined },
  ...
  { id: 11, date: new Date(2024, 8, 19, 1, 0, 0), note: undefined },
  { id: 12, date: new Date(2024, 8, 19, 2, 0, 0), note: "Cheio de energia para trabalhar." },
  { id: 13, date: new Date(2024, 8, 19, 3, 0, 0), note: undefined },
  { id: 14, date: new Date(2024, 8, 19, 4, 0, 0), note: "Orgulhoso das conquistas recentes." },
  { id: 15, date: new Date(2024, 8, 19, 5, 0, 0), note: undefined },
  ...
  { id: 19, date: new Date(2024, 8, 19, 9, 0, 0), note: undefined },
  { id: 20, date: new Date(2024, 8, 19, 10, 0, 0), note: "Sentindo-se envergonhado em público." },
  { id: 21, date: new Date(2024, 8, 19, 11, 0, 0), note: undefined },
  ...
  { id: 24, date: new Date(2024, 8, 19, 14, 0, 0), note: undefined },
  ...
  { id: 28, date: new Date(2024, 8, 19, 18, 0, 0), note: undefined },
  { id: 29, date: new Date(2024, 8, 19, 19, 0, 0), note: "Agradecido pelas pequenas coisas." },
  { id: 30, date: new Date(2024, 8, 19, 20, 0, 0), note: undefined },
  { id: 31, date: new Date(2024, 8, 19, 21, 0, 0), note: "Sentindo-se descansado." },
  { id: 32, date: new Date(2024, 8, 19, 22, 0, 0), note: undefined },
  { id: 33, date: new Date(2024, 8, 19, 23, 0, 0), note: "Com sono." },
  { id: 34, date: new Date(2024, 8, 20, 0, 0, 0), note: undefined },
